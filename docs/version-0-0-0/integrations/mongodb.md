...
- Category management
- Bulk imports
- `updateById` for targeted document updates
...
### Catalog Module
Unified pricing and fulfillment data via catalog snapshots.

**Collections:** `catalog_{tenantId}_{snapshotId}` (atoms, bindings, rules, availability, inventory)

**Operations:**
- Snapshot management
- Pricing atoms and bindings
- Pricing rules (grouped by `ruleOverlay`)
- Availability and inventory data
- Warehouse configurations

**Use Cases:**
- Unified catalog snapshots
- Pricing and fulfillment in single context
- Snapshot-based pricing calculation
- Warehouse-specific inventory queries
